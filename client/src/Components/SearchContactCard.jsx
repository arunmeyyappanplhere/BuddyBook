...
const SearchContactCard = ({
  ...
  return (
    <div
      className="bg-[#f9f9f934] w-full shadow-xs rounded-sm flex gap-4 md:gap-10 items-center py-1 px-4 cursor-pointer hover:bg-blue-100/50 transition"
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <h2 className="text-gray-500 text-sm truncate">{contactNumber}</h2>
      </div>
    </div>
  );
};
