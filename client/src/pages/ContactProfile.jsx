  ...
  return (
    <div className="flex flex-col items-center">
      <div className="text-center flex items-center justify-between p-5 shadow-sm rounded-b-sm w-full">
        ...
        <div>
          <img src={defaultImage} alt="" className="w-15 cursor-pointer" />
        </div>
      </div>
      <div className="w-6xl flex flex-col justify-center items-center h-full my-10">
        ...
        <div className="min-w-180 rounded-xl shadow-2xl min-h-100 mt-7 p-8">
          ...
          <div className="flex mb-6">
            <div className="flex-1">
              <h3 className="text-gray-400 text-md font-semibold">BIRTHDAY</h3>
            ...
            <div className="flex-1">
              ...
              <p className="font-semibold text-[#4648d4] bg-blue-100 w-min px-2 rounded-2xl">Profession</p>
            </div>
          </div>
          <div className="flex">
            <div>
              ...
              <p className="font-semibold">742 Evergreen Aparments, Star Colony, Mars</p>
            </div>
          </div>
        </div>
      </div>
