...
const ContactModal = () => {
  ...
  return (
    <div className="flex flex-col justify-center max-w-2/8 max-h-3/4 rounded-xl shadow-2xl bg-white px-6 py-10">
      <div className="flex justify-between">
        ...
        <X className=" text-gray-600 cursor-pointer hover:text-black transition duration-300" />
      </div>
      <div className="mt-10 flex justify-center">
        <form onSubmit={handleAddContact} className="">
          ...
          <div className="flex gap-5 justify-end">
            <button
              type="submit"
              className="min-w-30 flex gap-2 items-center justify-center text-black text-md cursor-pointer rounded-md min-h-9 p-2.5 hover:bg-gray-300 transition ease-in-out duration-100"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="min-w-30 flex gap-2 items-center justify-center text-white text-md cursor-pointer bg-blue-500  rounded-md min-h-9 p-2.5 hover:bg-blue-400 transition ease-in-out duration-100"
            >
              Save Contact
            </button>
          </div>
